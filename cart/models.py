...
class CartItem(models.Model):
    ...
    def delivery_price(self):
        try:
            ...
            if current_address.district == "Dhaka" or current_address.district == "Dhaka" :
                return 50

            elif current_address.district == "Dhaka" or current_address.district == "Dhaka" or current_address.district == "Dhaka" :
                return 50
